...
url = f'https://labdados.com/produtos?regiao={regiao}&ano={ano}'
...
fig_receita_estados = px.bar(receita_estados.head(), x='Local da compra', y='Preço', text_auto=True, title='Top 5 Estados (receita)')
